...
from idpy.core.utils.IdpySymbolic import SymmetricTensor, JSymmetricTensor
from idpy.core import idpy_langs_sys
from idpy.core import CTYPES_T, OCL_T, METAL_T, CUDA_T
...
class TestConvolutionMetal(_DeviceConvolutionMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        clear_convolution_shape()
        clear_active_tenet()
        from idpy.core import GetTenet
        try:
