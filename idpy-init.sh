...
WGET_PYOPENCL_2022=https://${USE_PYHOSTED_SERVER}/packages/6d/8a/1b9cf76c8ab2cb9099b5810810c74ec6c3f17737913218d6e2572a51d980/pyopencl-2022.1.5.tar.gz
WGET_PYOPENCL=${WGET_PYOPENCL_2022}
